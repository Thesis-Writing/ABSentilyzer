...
#                     display_final_output(pos_ensemble_prob_list,neg_ensemble_prob_list,neu_ensemble_prob_list,original_input_list,preprocessed_input_list,extracted_aspect_list,final_aspect_polarity_list,final_polarity_list)
#                     display_header(mode)
#                     display_footer(mode)
...
def display_final_output(pos_ensemble_prob_list, neg_ensemble_prob_list,
...
def get_preprocessed_table(original_input_list,preprocessed_input_list):
...
def get_final_sentence_polarity_table(original_input_list,final_polarity_list):
